CLASS zcl_170422016_open_sql_v2 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_170422016_open_sql_v2 IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.

    DATA:
      lt_emp    TYPE TABLE OF z170422016_t_emp,
      lt_insert TYPE TABLE OF z170422016_t_emp.
*
    DELETE FROM z170422016_t_emp.
*
**-------------------------------------------------------------
** 1. INSERT DATA
**-------------------------------------------------------------
*
    ...
    INSERT z170422016_t_emp FROM TABLE @lt_insert.
...
*
    SELECT emp_id,
      ...
      FROM z170422016_t_emp
      INTO TABLE @DATA(lt_num).
*
*---------------------------------------------------------------------
**3. STRING FUNCTIONS (FULL)
** İşlem: Birleştirme (CONCAT), Parçalama (SUBSTRING), Büyük/Küçük harf ve karakter işlemleri
**---------------------------------------------------------------------
*
    SELECT emp_id,
     ...
     WHEN amount > 6000 THEN 'Very High'
      WHEN amount BETWEEN 3000 AND 60000 THEN 'High'
...
SELECT emp_id FROM z170422016_t_emp
UNION ALL
SELECT emp_id FROM z170422016_t_emp
...
SELECT *
  ...
  SELECT emp_id,
      ...
      FROM z170422016_t_emp
      INTO TABLE @DATA(lt_contact_space).
