CLASS zcl_170422016_rest_client_02 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_170422016_rest_client_02 IMPLEMENTATION.
...
*   io_out->write( user_delete( ) ).
  ...
  METHOD user_get.
    ...
    rv_text = execute_request(
      iv_method = 'GET'
      iv_url    = gc_base_url && '/user/kardelenaydin' ).
...
METHOD build_user_json.
  rv_json =
    '{' &&
    '"id": 1001,' &&
    '"username": "kardelenaydin",' &&
    '"firstName": "kardelen",' &&
    '"lastName": "aydin",' &&
    '"email": "krdln_hzn@outlook.com",' &&
    '"password": "Yavuz2014.",' &&
    '"phone":"77777777777",' &&
    '"userStatus": 1' &&
    '}'.
